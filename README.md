...
O projeto é uma implementação simples e didática para demonstrar o seguinte fluxo:
...
| **Java HttpClient** | Comunicação HTTP com o ViaCEP |
| **Gson** | Conversão entre objetos Java e JSON |
| **Swing** | Interface gráfica para entrada do CEP |
...
A aplicação atualmente utiliza apenas parte dessas informações no modelo `CEP`, mantendo os campos:
...
- GitHub: [@Renanmc132](https://github.com/Renanmc132)
- Repositório: [ViaCepAPI](https://github.com/Renanmc132/ViaCepAPI)
...
<p align="center">
  Desenvolvido com ☕ Java e 💻 dedicação por <strong>Renanmc132</strong>.
</p>
